...
import com.futurevalley.adapter.SeriesAdapter;
...
public class SearchAllSeriesActivity extends AppCompatActivity {
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            if (isFirst) {
                isFirst = false;
                adapter = new SeriesAdapter(SearchAllSeriesActivity.this, mListItem);
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(SearchAllSeriesActivity.this, SeriesDetailsActivity.class);
