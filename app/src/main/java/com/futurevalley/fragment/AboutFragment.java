...
import com.futurevalley.item.ItemAbout;
...
public class AboutFragment extends Fragment {
    ...
    private void setResult() {
        ...
        String text = "<html dir=" + direction + "><head>"
                + "<style type=\"text/css\">@font-face {font-family: MyFont;src: url(\"file:///android_asset/fonts/custom.ttf\")}body{font-family: MyFont;color: #767676;text-align:justify;margin-left:0px;line-height:1.2}"
                + "</style></head>"
                + "<body>"
                + htmlText
                + "</body></html>";
